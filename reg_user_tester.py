...
def press(c,voice):
    ...
    if c == "usergesture":
        if user_ges:
            user_ges = False
            print("userges deactivated")
        else:
            user_ges = True
            print("userges activated")
    else:
        cl = c.split('+')
        if len(cl)==1:
            if c == "restart":
...
def custom_detection_():
    ...
    model_file_name1 = 'new_gesture_model.sav'
    model2 = pickle.load(open(model_file_name1, 'rb'))
    ...
    while (cap.isOpened()):
        ...
        if results.multi_hand_landmarks!=0:
            if results.multi_hand_landmarks:
                ...
                prediction2 = model2.predict([row_list])
                # print(prediction)
                ...
                if prediction[0]==0 and proceed and auth:
                    ...
                    if ges_12 > 12:
                        ...
                        power_seq = ""
                        ges_12 = 0
                elif prediction[0]==11 and not user_ges:
                    ges_11 += 1
                    zoom_in = 0
                    zoom_out = 0
                    if ges_11 > 12:
                        ...
                        power_seq = ""
                        ges_11 = 0
                if mous==True and proceed==False and mouse and not user_ges:
